...
if ($all_products) {
    foreach ($all_products as $kode => $prod) {
        // Jika search bar kosong, ATAU nama barang mengandung kata kunci pencarian
        if ($search === '' || (isset($prod['brgNama']) && stripos($prod['brgNama'], $search) !== false)) {
            $prod['brgKode'] = $kode; // Inject key ke dalam array
            ...
            ?>
                    ...
                    <div class="product-item"  
                        ...
                        <div class="product-info">
                            ...
                            <p>Stock : <?php echo htmlspecialchars($row['brgStok'] ?? 0); ?></p>
                            <p>Harga: <?php echo "Rp " . number_format($row['brgHarga'] ?? 0, 0, ',', '.'); ?></p>
                        </div>
